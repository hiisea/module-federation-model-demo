...
import {AppConfig, setConfig} from '@elux/vue-web';
import {HomeUrl} from '@react-team/stage-model';
import stage from '@vue-team/stage';
...
export const ModuleGetter = {
  ...
  stage: () => stage,
  article: () => import('@vue-team/article'),
  shop: () => import('@vue-team/shop'),
  admin: () => import('@vue-team/admin'),
  my: () => import('@vue-team/my'),
};
