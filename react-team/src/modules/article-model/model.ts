//定义本模块的业务模型
import {BaseModel, effect, reducer} from '@elux/model';
import {CommonErrorCode, CustomError} from '@react-team/stage-model';
import {mergeDefaultParams} from '@react-team/stage-model';
